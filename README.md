...
### Biofilm Simulator — Arcade Edition (V4.3)

Fais croître ton biofilm dans une canalisation industrielle : développe tes
cellules, sécrète ta matrice protectrice, sporule pour résister, et survis aux
cycles de nettoyage (NEP/CIP). Objectif : colmater la canalisation avant que
tes cellules ne soient éradiquées.
